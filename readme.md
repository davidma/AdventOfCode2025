...
Hohoho - back again with more daily head-bashing, while trying to solve code in a languauge I dont use much, so that I can get better at it.
...
- Day5:  Both parts, last part took a bit of thinking!
- Day6:  Both parts, all good (once I leared how strip() works...)
- Day7:  Both parts, no big issues
- Day8:  Both parts, but pressed for time, so had a look at the subreddit for general ideas
- Day9:  Both parts, all good. 
- Day10: Both parts, had to resort to z3 and someone elses code for part 2
